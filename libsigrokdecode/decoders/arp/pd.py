...
class Decoder(srd.Decoder):
    ...
    def decode(self, startsample, endsample, data):
        ...
        if arp.ptype in ethertype:
            ...
            self.putx([0, ['Protocol: UNKNOWN', 'UNKNOWN']])
