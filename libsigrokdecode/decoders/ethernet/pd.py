    ...
    def decode(self, startsample, endsample, data):
        ...
        # Destination MAC address
            ...
            if len(self.buffer) == 6:
                ...
                # Add preamble annotation
                self.es_block = endsample
                self.putx([0, ['Destination MAC: {}'.format(dst_mac), 
                               'Dst MAC: {}'.format(dst_mac)]])
        ...
        # Source MAC address
            ...
            if len(self.buffer) == 6:
                ...
                # Add preamble annotation
                self.es_block = endsample
                self.putx([0, ['Source MAC:    {}'.format(src_mac), 
                               'Src MAC: {}'.format(src_mac)]])
        ...
        # EtherType
            ...
            if len(self.buffer) == 2:
                ...
                # Unknown EtherType
                    ...
                    self.es_block = endsample
                    self.putx([0, ['EtherType: UNKNOWN', 'UNKNOWN']])
