...
class EmmcSdGenerator:
    """eMMC/SD card command protocol generator.
    ...
    def send_command(self, cmd, arg=0x00000000):
        """Send an eMMC/SD command token (48 bits).
    ...
    def generate_testdata(self):
        ...
        # Send CMD1 (SEND_OCR_IN_IDLE)
        self.send_command(1, 0x40FF8000)
