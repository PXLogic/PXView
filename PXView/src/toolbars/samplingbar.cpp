...
namespace dsv
{
    namespace toolbars
    {
        ...
        void SamplingBar::update_sample_count_selector()
        {
            ...
            do
            {
                ...
                if (mode == DSO)
                    ...
                    //not_last = (duration / SR_SEC(1) * samplerate > SR_KB(0));
                }
        ...
        {
            //_mode_action->setChecked(true);
            //_mode_action->triggered();
            //_mode_button.click();
            
            // if(_mode_button.isDown()){
            //     _mode_button.released();
            //     _mode_menu->hide();
            // }
            // else {
            //     _mode_button.pressed();
            // }

            //_mode_button.showMenu();
