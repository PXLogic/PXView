    ...
    
{
    ...
    // //_menu = _menubar.addMenu("Setting");
    ...
    //_menu->setStyleSheet("QMenu { layout-direction: left-to-right; }");
    ...
    //_tabwidget.addTab(&_toolbar,"Setting");
    ...
    //cancel help nop space allig other bar
