...
namespace appcore {
    ...
    void MainWindow::setup_ui()
    {
        ...
        // _central_widget->setWindowFlags(Qt::Widget | Qt::FramelessWindowHint | Qt::WindowStaysOnTopHint);
        // _central_widget->setAttribute(Qt::WA_X11DoNotAcceptFocus, true);



        // _toolbar_widget = new QWidget(this);
        // _horizontal_layout = new QHBoxLayout(_toolbar_widget);
        // _horizontal_layout->setSpacing(0);
        // _horizontal_layout->setContentsMargins(0, 0, 0, 0);
         //setCentralWidget(_toolbar_widget);
        ...
        _search_dock = new QDockWidget(L_S(STR_PAGE_DLG, S_ID(IDS_DLG_SEARCH_DOCK_TITLE), "Search..."), this);
        _search_dock->setObjectName("search_dock");  //不知道为何，不修改名字不生效
        ...
        _trig_bar->set_mainform_callback(this);
        ...
        else if (_device_agent->is_demo())
        {
            ...
            if (dir.exists())
            {
                QString ses_name = dir.absolutePath() + "/" 
                            + _device_agent->driver_name() + QString::number(mode) + ".pxc";
